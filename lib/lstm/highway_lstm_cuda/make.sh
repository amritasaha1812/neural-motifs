...
CUDA_PATH=/opt/share/cuda-9.0/x86_64  #/usr/local/cuda/
...
/opt/share/cuda-9.0/x86_64/bin/nvcc -c -o highway_lstm_kernel.cu.o highway_lstm_kernel.cu --compiler-options -fPIC $CUDA_MODEL_TARGETS
cd ../
python build.py
