...
class ModelConfig(object):
    ...
    def setup_parser(self):
        ...
        parser.add_argument('-coco_type', dest='coco_type', help='Use coco or coco_gold', default='')
        parser.add_argument('-coco_year', dest='coco_year', help='Use 2014/2017 for coco', default='')
        parser.add_argument('-coco_split', dest='coco_split', help='Use train/val for coco', default='')
        ...
        parser.add_argument('-train', dest='train', help='train set', action='store_true')
...
coco_type = conf.args['coco_type']
coco_year = conf.args['coco_year']
coco_split = conf.args['coco_split']

def path(fn):
    return os.path.join(DATA_PATH, fn)

def stanford_path(fn):
    return os.path.join(ROOT_PATH, 'preprocessing/data_tools/'+coco_type+'/'+coco_year+'/'+coco_split, fn)

# =============================================================================
# Update these with where your data is stored ~~~~~~~~~~~~~~~~~~~~~~~~~

VG_IMAGES = os.path.join(DATA_PATH, coco_type+'/'+coco_split+coco_year)
...
COCO_PATH = '/dccstor/cssblr/amrita/Mask_RCNN/data/coco'
# =============================================================================
# =============================================================================
