...
def val_batch(batch_num, b, evaluator, thrs=(20, 50, 100)):
    ...
    for i, (boxes_i, objs_i, obj_scores_i, obj_dists_i, rels_i, pred_scores_i) in enumerate(det_res):
        gt_entry = {
            'image_filename': val.filenames[batch_num + i],
        ...
        pred_entry = {
            ...
            'obj_dists': obj_dists_i,
            'rel_scores': pred_scores_i,
            'image_filename': gt_entry['image_filename'],
